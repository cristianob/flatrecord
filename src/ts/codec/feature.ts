...
import { buildGeometry, type IParsedGeometry } from './geometry.js';
...
export function buildFeature(geometry: IParsedGeometry | null, properties: IProperties, header: HeaderMeta): Uint8Array {
    ...
    const geometryOffset = geometry ? buildGeometry(builder, geometry) : 0;
    Feature.startFeature(builder);
    if (geometryOffset) Feature.addGeometry(builder, geometryOffset);
...
/**
 * Parse properties from a FlatRecord feature.
